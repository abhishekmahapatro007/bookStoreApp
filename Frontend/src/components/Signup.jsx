                    ...
                    <div className="modal-box">
                        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                            ...
                            <div className='flex justify-between mt-5'>
                                <button className='bg-pink-500 text-white rounded-md px-3 py-1 hover:bg-white hover:text-pink-700 duration-200'>Signup</button>
                                <p className='text-xl'>Have account?
                                    <button className='underline text-blue-500 cursor-pointer ml-2' onClick={() => document.getElementById("my_modal_3").showModal()}>Login</button>{" "}
                                    <Login />
                                </p>
                            </div>
                        </form>
